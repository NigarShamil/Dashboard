            ...
            <BlockContentWrap className="stacked-bar-chart">
                <ResponsiveContainer width='100%' heigth='100%'>
                    ...
                    >
                        ...
                        <Legend iconType="circle" iconSize={10} formatter={formatLegendValue} />
                        <Bar dataKey="volume" stackId="a" fill="#0095ff" radius={[0, 0, 4, 4]} barSize={16} />
                        <Bar dataKey="services" stackId="a" fill="#00e096" radius={[4, 4, 0, 0]} barSize={16} />
                    </BarChart>
                </ResponsiveContainer>
            </BlockContentWrap>
        </VolumeServiceWrap>
