        ...
        <AppBarWrap>
            <div className='appbar-content'>
                <div className='appbar-left'>
                    <button type='button' className='sidebar-open-btn' onClick={() => dispatch(setSidebarOpen())}>
                    ...
                    <div className='appbar-search'>
                        <form>
                            <div className='input-group'>
                                <span className='input-icon' onClick={handleInputControlVisibility}>
                                    <img src={Icons.SearchBlue} alt="" className='input-icon-img' />
                                </span>
                                <input ref={inputControlRef} type="text" placeholder='Search here ...' className={`input-control ${showInputControl ? "show-input-control " : ""}`} />
                            </div>
                        </form>
                    </div>
                    <AppBarLang />
